      ...
      <el-row :gutter="40">
        ...
        <el-col :span="10">
          <el-card class="right" style=" width: 100%;  padding: 5px; margin-bottom: 5px">
            <h3 style="margin-bottom: 10px">特征列信息</h3>
<!--            <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange" disabled>全选</el-checkbox>-->
            ...
            <el-checkbox-group v-model="checkedColumns" @change="handleCheckedColumnsChange">
              <el-checkbox v-for="col in columns" :label="col" :key="col.columnId" border size="small" style="margin: 2px" disabled>Id:{{col.columnId}}-列名:{{col.columnName}}</el-checkbox>
            </el-checkbox-group>
          </el-card>
          <el-card class="right" style=" width: 100%;  padding: 5px; margin-bottom: 5px">
          ...
          <el-card class="right" style=" width: 100%;  padding: 5px; margin-bottom: 5px">
            <h3 style="margin-bottom: 10px">请选择表征算法</h3>
